...
//        System.out.println("<134> 1 2013 Nov 26 11:46:51 172.254.100.10 FW - DSLITE:SessionbasedW".split(" ").length);
    ...
    public void distinct() {
        String field = "event_id、data_id、event_time、center_time、event_source_id、hashid、event_id、time、event_time、event_local_time、per_time、i_hash_id、time_local、transaction_id、trap_oid";
        List<String> collect = Arrays.stream(field.split("、")).distinct().collect(Collectors.toList());
